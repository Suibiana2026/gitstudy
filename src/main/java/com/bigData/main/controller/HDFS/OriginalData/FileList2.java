...
import com.bigData.main.pojo.HDFS.FileInfo2;
import com.bigData.main.pojo.HDFS.FolderInfo2;
...
public class FileList2 {
    ...
    private List<FileInfo2> processFileStatus(FileStatus[] files) {
        return Arrays.stream(files)
                .filter(fileStatus -> !fileStatus.isDirectory()) // 只保留文件，不包含文件夹
                .map(fileStatus -> new FileInfo2(
